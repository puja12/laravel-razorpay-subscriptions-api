...
<script>
    var options = {
        ...
        "handler": function (response){
            // After payment is successfull response will come here and  send this response to Controller to update the payment response
            // Create a form to send this data and Set the data in form
